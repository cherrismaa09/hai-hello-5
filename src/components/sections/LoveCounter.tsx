...
const START_DATE = new Date("2021-03-13T00:00:00");
    ...
    <section className="py-20 px-6">
      <FadeInSection>
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-muted-foreground mb-10">Its already ...</p>
          ...
          <p className="text-muted-foreground mb-10 mx-auto text-center">Assalu nammaleka pothuna boo.. that we made it till today ani</p>
        </div>
      </FadeInSection>
    </section>
  );
